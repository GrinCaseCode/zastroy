$(document).ready(function() {
	 ...
	 $(".item-form_variable select").change(function(){

  if ($(this).val() == "variable-1") {
			$("#variable-1").fadeIn(200);
			$("#variable-2").fadeOut(0);
		}
		if ($(this).val() == "variable-2") {
			$("#variable-2").fadeIn(200);
			$("#variable-1").fadeOut(0);
		}

  });

	$(".more-filter").click(function() {
	if ($(this).siblings(".brands-list").find(".checkbox_catalog:nth-child(n+7)").is(":hidden")) {
			$(this).find("span").html("Свернуть");
			$(this).siblings(".brands-list").find(".checkbox_catalog:nth-child(n+7)").slideDown(200);
			$(this).addClass("active");
		} else {
			$(this).find("span").html("Все производители");
			$(this).siblings(".brands-list").find(".checkbox_catalog:nth-child(n+7)").slideUp(200);
...
$(".filter-open").click(function(e) {
	e.preventDefault();
	$(".filter-sidebar").fadeToggle(200);
});

$(".filter-sidebar__close").click(function(e) {
	e.preventDefault();
